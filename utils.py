...
def handle_argv(target, config_train, prefix):
    ...
    parser.add_argument('dataset', type=str, help='Dataset name', choices=['hhar', 'motion', 'uci', 'shoaib', 'camargo', 'molinaro', 'scherpereel', 'scherpereel_exo'])
    parser.add_argument('dataset_version',  type=str, help='Dataset version', choices=['10_100', '20_120', '10_20', '10_60', '10_20_dense', '10_20_dense_8cls', '10_20_both','10_20_dense_9cls','10_20_both_dense_9cls','10_20_both_negy_xz'])
